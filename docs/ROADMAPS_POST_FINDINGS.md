...
| 14 | Auto-approbation | Un jeton `developer` peut relire une proposition qu'il a déposée sous un `agent_id` de sa machine : conforme (frontière = rôle, DEC-0085/0090), la trace reste complète. | Séparation stricte proposant/relecteur = nouveau contrat, à décider si le besoin apparaît. |
