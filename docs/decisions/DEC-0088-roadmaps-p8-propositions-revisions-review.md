...
# DEC-0088 — Roadmaps P8 : propositions, revisions et relecture humaine
...
- P6 (contexte) peut exposer `draft_pending`/propositions ; la consommation par
  `studio_prepare_context` reste à la lane P6, sans dépendance de ce lot.
- Graphify : à rafraîchir depuis la racine réelle après merge
  (`pwsh -NoProfile -File scripts/graphify-studio.ps1 --update`).
