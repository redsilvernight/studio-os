...
| DEC-0078 | Transitions de decision : POST /decisions/{id}/accept et /supersede, admin-only, statuts inchanges | active | [decisions/DEC-0078-transitions-de-decision-accept-supersede-admin.md](decisions/DEC-0078-transitions-de-decision-accept-supersede-admin.md) |
